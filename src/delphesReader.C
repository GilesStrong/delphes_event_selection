...
void delphesReader::Init(TTree *tree) {
	...
	fChain->SetBranchAddress("PhotonLoose", &Photon_, &b_Photon_);
	fChain->SetBranchAddress("PhotonLoose.fUniqueID", Photon_fUniqueID, &b_Photon_fUniqueID);
	fChain->SetBranchAddress("PhotonLoose.fBits", Photon_fBits, &b_Photon_fBits);
	fChain->SetBranchAddress("PhotonLoose.PT", Photon_PT, &b_Photon_PT);
	fChain->SetBranchAddress("PhotonLoose.Eta", Photon_Eta, &b_Photon_Eta);
	fChain->SetBranchAddress("PhotonLoose.Phi", Photon_Phi, &b_Photon_Phi);
	fChain->SetBranchAddress("PhotonLoose.E", Photon_E, &b_Photon_E);
	fChain->SetBranchAddress("PhotonLoose.T", Photon_T, &b_Photon_T);
	fChain->SetBranchAddress("PhotonLoose.EhadOverEem", Photon_EhadOverEem, &b_Photon_EhadOverEem);
	fChain->SetBranchAddress("PhotonLoose.Particles", Photon_Particles, &b_Photon_Particles);
	fChain->SetBranchAddress("PhotonLoose.IsolationVar", Photon_IsolationVar, &b_Photon_IsolationVar);
	fChain->SetBranchAddress("PhotonLoose.IsolationVarRhoCorr", Photon_IsolationVarRhoCorr, &b_Photon_IsolationVarRhoCorr);
	fChain->SetBranchAddress("PhotonLoose.SumPtCharged", Photon_SumPtCharged, &b_Photon_SumPtCharged);
	fChain->SetBranchAddress("PhotonLoose.SumPtNeutral", Photon_SumPtNeutral, &b_Photon_SumPtNeutral);
	fChain->SetBranchAddress("PhotonLoose.SumPtChargedPU", Photon_SumPtChargedPU, &b_Photon_SumPtChargedPU);
	fChain->SetBranchAddress("PhotonLoose.SumPt", Photon_SumPt, &b_Photon_SumPt);
	fChain->SetBranchAddress("PhotonLoose_size", &Photon_size, &b_Photon_size);
