...
void delphesReader::Init(TTree *tree) {
	...
	fChain->SetBranchAddress("Muon", &MuonLoose_, &b_Muon_);
	fChain->SetBranchAddress("Muon.fUniqueID", MuonLoose_fUniqueID, &b_Muon_fUniqueID);
	fChain->SetBranchAddress("Muon.fBits", MuonLoose_fBits, &b_Muon_fBits);
	fChain->SetBranchAddress("Muon.PT", MuonLoose_PT, &b_Muon_PT);
	fChain->SetBranchAddress("Muon.Eta", MuonLoose_Eta, &b_Muon_Eta);
	fChain->SetBranchAddress("Muon.Phi", MuonLoose_Phi, &b_Muon_Phi);
	fChain->SetBranchAddress("Muon.T", MuonLoose_T, &b_Muon_T);
	fChain->SetBranchAddress("Muon.Charge", MuonLoose_Charge, &b_Muon_Charge);
	fChain->SetBranchAddress("Muon.Particle", MuonLoose_Particle, &b_Muon_Particle);
	fChain->SetBranchAddress("Muon.IsolationVar", MuonLoose_IsolationVar, &b_Muon_IsolationVar);
	fChain->SetBranchAddress("Muon.IsolationVarRhoCorr", MuonLoose_IsolationVarRhoCorr, &b_Muon_IsolationVarRhoCorr);
	fChain->SetBranchAddress("Muon.SumPtCharged", MuonLoose_SumPtCharged, &b_Muon_SumPtCharged);
	fChain->SetBranchAddress("Muon.SumPtNeutral", MuonLoose_SumPtNeutral, &b_Muon_SumPtNeutral);
	fChain->SetBranchAddress("Muon.SumPtChargedPU", MuonLoose_SumPtChargedPU, &b_Muon_SumPtChargedPU);
	fChain->SetBranchAddress("Muon.SumPt", MuonLoose_SumPt, &b_Muon_SumPt);
	fChain->SetBranchAddress("Muon_size", &MuonLoose_size, &b_Muon_size);
