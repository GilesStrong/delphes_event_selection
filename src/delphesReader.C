...
void delphesReader::Init(TTree *tree) {
	...
	fChain->SetBranchAddress("Muon", &MuonLoose_, &b_MuonLoose_);
	fChain->SetBranchAddress("Muon.fUniqueID", MuonLoose_fUniqueID, &b_MuonLoose_fUniqueID);
	fChain->SetBranchAddress("Muon.fBits", MuonLoose_fBits, &b_MuonLoose_fBits);
	fChain->SetBranchAddress("Muon.PT", MuonLoose_PT, &b_MuonLoose_PT);
	fChain->SetBranchAddress("Muon.Eta", MuonLoose_Eta, &b_MuonLoose_Eta);
	fChain->SetBranchAddress("Muon.Phi", MuonLoose_Phi, &b_MuonLoose_Phi);
	fChain->SetBranchAddress("Muon.T", MuonLoose_T, &b_MuonLoose_T);
	fChain->SetBranchAddress("Muon.Charge", MuonLoose_Charge, &b_MuonLoose_Charge);
	fChain->SetBranchAddress("Muon.Particle", MuonLoose_Particle, &b_MuonLoose_Particle);
	fChain->SetBranchAddress("Muon.IsolationVar", MuonLoose_IsolationVar, &b_MuonLoose_IsolationVar);
	fChain->SetBranchAddress("Muon.IsolationVarRhoCorr", MuonLoose_IsolationVarRhoCorr, &b_MuonLoose_IsolationVarRhoCorr);
	fChain->SetBranchAddress("Muon.SumPtCharged", MuonLoose_SumPtCharged, &b_MuonLoose_SumPtCharged);
	fChain->SetBranchAddress("Muon.SumPtNeutral", MuonLoose_SumPtNeutral, &b_MuonLoose_SumPtNeutral);
	fChain->SetBranchAddress("Muon.SumPtChargedPU", MuonLoose_SumPtChargedPU, &b_MuonLoose_SumPtChargedPU);
	fChain->SetBranchAddress("Muon.SumPt", MuonLoose_SumPt, &b_MuonLoose_SumPt);
	fChain->SetBranchAddress("Muon_size", &MuonLoose_size, &b_MuonLoose_size);
