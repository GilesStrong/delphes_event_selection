...
int main(int argc, char *argv[]) { //input, output, N events, truth
	...
	e_tau->Branch("gen_t_0_mass", &gen_t_0_mass);
	...
	e_tau->Branch("gen_t_1_mass", &gen_t_1_mass);
	...
	e_tau->Branch("gen_h_tt_mass", &gen_h_tt_mass);
	...
	mu_tau->Branch("gen_t_0_mass", &gen_t_0_mass);
	...
	mu_tau->Branch("gen_t_1_mass", &gen_t_1_mass);
	...
	mu_tau->Branch("gen_h_tt_mass", &gen_h_tt_mass);
	...
	tau_tau->Branch("gen_t_0_mass", &gen_t_0_mass);
	...
	tau_tau->Branch("gen_t_1_mass", &gen_t_1_mass);
	...
	tau_tau->Branch("gen_h_tt_mass", &gen_h_tt_mass);
	...
	e_e->Branch("gen_t_0_mass", &gen_t_0_mass);
	...
	e_e->Branch("gen_t_1_mass", &gen_t_1_mass);
	...
	e_e->Branch("gen_h_tt_mass", &gen_h_tt_mass);
	...
	mu_mu->Branch("gen_t_0_mass", &gen_t_0_mass);
	...
	mu_mu->Branch("gen_t_1_mass", &gen_t_1_mass);
	...
	mu_mu->Branch("gen_h_tt_mass", &gen_h_tt_mass);
	...
	e_mu->Branch("gen_t_0_mass", &gen_t_0_mass);
	...
	e_mu->Branch("gen_t_1_mass", &gen_t_1_mass);
	...
	e_mu->Branch("gen_h_tt_mass", &gen_h_tt_mass);
